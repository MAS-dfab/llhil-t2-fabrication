...
class ScrewSolver:
    ...
    def populate_aligned_entry_points(self, joint, orientation="bisector", nested=False):
        """
    ...
    def populate_aligned_screw_lines(self, joint, orientation="bisector", nested=False, restrict=True):
        """
    ...
    def populate_crossed_entry_points(self, joint, orientation="along_cross", nested=False):
        """
    ...
    def populate_crossed_screw_lines(self, joint, orientation="along_cross", nested=False, restrict=True):
        """
